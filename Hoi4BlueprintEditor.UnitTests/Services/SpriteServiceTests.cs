...
public class SpriteServiceTests
{
    ...
    public void TryGetSpriteInfo_ShouldLoadSpritesFromTestData()
    {
        ...
        var result1 = _spriteService.TryGetSpriteInfo("GFX_test_1", out var info1);
        ...
        var result2 = _spriteService.TryGetSpriteInfo("GFX_test_2", out var info2);
        ...
        var result3 = _spriteService.TryGetSpriteInfo("GFX_test_3", out var info3);
    ...
    {
        var result = _spriteService.TryGetSpriteInfo("NON_EXISTENT_SPRITE", out var info);
